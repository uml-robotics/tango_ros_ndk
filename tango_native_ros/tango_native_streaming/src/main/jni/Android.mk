...
LOCAL_SRC_FILES := $(PROJECT_ROOT)/EXTRACT_TANGO_CLIENT_LIBRARY_HERE/lib_tango_client_api/lib/$(TARGET_ARCH_ABI)/libtango_client_api.so
...
LOCAL_MODULE    := tango_native_streaming
