...
LOCAL_SRC_FILES := $(PROJECT_ROOT)/EXTRACT_TANGO_CLIENT_LIBRARY_HERE/lib_tango_client_api/armeabi-v7a/libtango_client_api.so
LOCAL_EXPORT_C_INCLUDES += $(PROJECT_ROOT)/EXTRACT_TANGO_CLIENT_LIBRARY_HERE/lib_tango_client_api
